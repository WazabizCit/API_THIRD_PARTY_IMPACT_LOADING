...
exports.mid_basicauth = (req, res, next) => {
  ...
  if (!authHeader) {
    ...
    const validUsername = config.main_config.USERNAME_BASIC_AUTH;
    const validPassword = config.main_config.PASSWORD_BASIC_AUTH;
